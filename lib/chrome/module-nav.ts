...
export const MODULE_NAV: readonly ModuleNav[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { name: 'View portal', href: '/dashboard/fitgraph/portal', desc: 'See what customers see · pick sections', section: 'Grow' },
  ...
  },
  {
    ...
    steps: [
      ...
      { name: 'View portal', href: '/dashboard/physiograph/portal', desc: 'See what patients see · pick sections', section: 'Grow' },
      { name: 'Website', href: '/dashboard/physiograph/website', desc: 'Portal setup · member app QR · booking', section: 'Grow' },
  ...
  },
  {
    ...
    steps: [
      ...
      { name: 'View portal', href: '/dashboard/dentalgraph/portal', desc: 'See what patients see · pick sections', section: 'Grow' },
      { name: 'Website', href: '/dashboard/dentalgraph/website', desc: 'Portal setup · member app QR · booking', section: 'Grow' },
  ...
  },
  {
    ...
    steps: [
      ...
      { name: 'View portal', href: '/dashboard/psychiatrygraph/portal', desc: 'See what patients see · pick sections', section: 'Grow' },
      { name: 'Website', href: '/dashboard/psychiatrygraph/website', desc: 'Portal setup · member app QR · booking', section: 'Grow' },
  ...
  },
  {
    ...
    steps: [
      ...
      { name: 'Rooms', href: '/dashboard/medicalgraph/rooms', desc: 'Consult rooms · equipment', section: 'Floor' },
      ...
      { name: 'View portal', href: '/dashboard/medicalgraph/portal', desc: 'See what patients see · pick sections', section: 'Grow' },
      { name: 'Website', href: '/dashboard/medicalgraph/website', desc: 'Portal setup · member app QR · booking', section: 'Grow' },
  ...
  },
  {
    ...
    steps: [
      ...
      { name: 'View portal', href: '/dashboard/hiregraph/portal', desc: 'See what hirers see · pick sections', section: 'Grow' },
      { name: 'Website', href: '/dashboard/hiregraph/website', desc: 'Portal setup · member app QR · catalogue', section: 'Grow' },
  ...
  },
  {
    ...
    steps: [
      ...
      { name: 'View portal', href: '/dashboard/retailgraph/portal', desc: 'See what shoppers see · pick sections', section: 'Grow' },
      { name: 'Website', href: '/dashboard/retailgraph/website', desc: 'Portal setup · member app QR · shop', section: 'Grow' },
    ],
  },
  {
    id: 'schools',
