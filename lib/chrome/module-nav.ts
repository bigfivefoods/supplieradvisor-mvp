...
export const MODULE_NAV: readonly ModuleNav[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { name: 'Memberships', href: '/dashboard/fitgraph/memberships', desc: 'Class rates · subscribe', section: 'Services' },
      { name: 'Subscriptions', href: '/dashboard/fitgraph/subscriptions', desc: 'Subscribe members to classes', section: 'Services' },
      { name: 'Classes', href: '/dashboard/fitgraph/classes', desc: 'Timetable · class fees', section: 'Services' },
