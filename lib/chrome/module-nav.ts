...
export const MODULE_NAV: readonly ModuleNav[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      { name: 'Classes', href: '/dashboard/fitgraph/memberships', desc: 'The class is the membership · rates', section: 'Services' },
      { name: 'Membership', href: '/dashboard/fitgraph/membership', desc: 'Member list, class rate, charged rate, allocate to a class', section: 'Services' },
      { name: 'Subscriptions', href: '/dashboard/fitgraph/subscriptions', desc: 'Pause · cancel · credits', section: 'Services' },
