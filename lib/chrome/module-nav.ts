...
export const MODULE_NAV: readonly ModuleNav[] = [
  ...
  },
  {
    ...
    resource: 'schools',
    steps: [
      { name: 'Command', href: '/dashboard/schools', exact: true, desc: 'Programme home', group: 'DBE', section: 'Govern' },
      { name: 'Desk', href: '/dashboard/schools/agency', desc: 'Profile · tariffs · associations', group: 'DBE', section: 'Govern' },
      { name: 'Join & add', href: '/dashboard/schools/join', desc: 'Schools & SPs · approve joins', group: 'DBE', section: 'Govern' },
      { name: 'Import schools', href: '/dashboard/schools/registry-import', desc: 'Bulk provincial school register', group: 'DBE', section: 'Govern' },
      { name: 'Import SPs', href: '/dashboard/schools/sp-registry-import', desc: 'District · cluster · CSD · SP name', group: 'DBE', section: 'Govern' },
      { name: 'Management report', href: '/dashboard/schools/report', desc: 'A4 landscape PDF · key metrics · kitchen audits', group: 'DBE', section: 'Insights' },
      { name: 'School register', href: '/dashboard/schools/registry-report', desc: 'Full school list · geo · enrolments · RIAD', group: 'DBE', section: 'Insights' },
      { name: 'Service providers', href: '/dashboard/schools/sp-register', desc: 'SP directory · district · CSD · RIAD', group: 'DBE', section: 'Insights' },
      { name: 'Ops cockpit', href: '/dashboard/schools/ops', desc: 'Exceptions · districts · clusters', group: 'DBE', section: 'Insights' },
      { name: 'Reports', href: '/dashboard/schools/agency-report', desc: 'Slice & dice · RIAD log · claims · risks', group: 'DBE', section: 'Insights' },
      { name: 'Map', href: '/dashboard/schools/map', desc: 'School locations', group: 'DBE', section: 'Insights' },
      { name: 'Kitchen safety', href: '/dashboard/schools/kitchen-safety', desc: 'CoA register · R638 risk · claim gate', group: 'DBE', section: 'Insights' },
      { name: 'Catalogue', href: '/dashboard/schools/approved-list', desc: 'Approved foods list', group: 'DBE', section: 'Programme' },
      { name: 'Menu', href: '/dashboard/schools/menu', desc: 'Breakfast + lunch cycle', group: 'DBE', section: 'Programme' },
      { name: 'Recipes', href: '/dashboard/schools/recipes', desc: 'BOM · MPS · MRP · category budgets', group: 'DBE', section: 'Programme' },
      { name: 'Feeding calendar', href: '/dashboard/schools/feeding-calendar', desc: 'Annual feeding days · terms · months', group: 'DBE', section: 'Programme' },
      { name: 'Nutrition', href: '/dashboard/schools/nutrition-agency', desc: 'Programme nutrition', group: 'DBE', section: 'Programme' },
      { name: 'SP SLA', href: '/dashboard/schools/isp-sla', desc: 'Supplier performance', group: 'DBE', section: 'Field' },
      { name: 'Trip calendar', href: '/dashboard/schools/visits', desc: 'Plan PEU circuits · calendar · planned vs actual', group: 'DBE', section: 'Field' },
      { name: 'Monitoring form', href: '/dashboard/schools/monitoring', desc: 'Full KZN tool · open from planned stops', group: 'DBE', section: 'Field' },
      { name: 'Monitoring report', href: '/dashboard/schools/monitoring-report', desc: 'Filters · graphs · KPI analytics', group: 'DBE', section: 'Field' },
      { name: 'Prizes', href: '/dashboard/schools/prizes', desc: 'Headmaster prizes', group: 'DBE', section: 'Field' },
      { name: 'Command', href: '/dashboard/schools', exact: true, desc: 'Readiness & next action', group: 'School', section: 'Home' },
      { name: 'Supply ops', href: '/dashboard/schools/ops', desc: 'Match · funding sim · audit pack', group: 'School', section: 'Home' },
      { name: 'Profile', href: '/dashboard/schools/profile', desc: 'EMIS · kitchen · principal', group: 'School', section: 'Home' },
      { name: 'Join DBE', href: '/dashboard/schools/join', desc: 'Request department link', group: 'School', section: 'Home' },
      { name: 'Management report', href: '/dashboard/schools/report', desc: 'A4 landscape PDF · key metrics · kitchen audits · this school', group: 'School', section: 'Insights' },
      { name: 'Learners', href: '/dashboard/schools/learners', desc: 'NSNP register', group: 'School', section: 'People' },
      { name: 'Staff', href: '/dashboard/schools/staff', desc: 'Kitchen team', group: 'School', section: 'People' },
      { name: 'Menu', href: '/dashboard/schools/menu', desc: 'Department menu', group: 'School', section: 'Supply' },
      { name: 'Recipes / MRP', href: '/dashboard/schools/recipes', desc: 'Learner-scaled meal product plan', group: 'School', section: 'Supply' },
      { name: 'Feeding calendar', href: '/dashboard/schools/feeding-calendar', desc: 'DBE feeding days · terms · months', group: 'School', section: 'Supply' },
      { name: 'Approved foods', href: '/dashboard/schools/approved-list', desc: 'What you may order', group: 'School', section: 'Supply' },
      { name: 'SPs', href: '/dashboard/schools/isps', desc: 'Service providers', group: 'School', section: 'Supply' },
      { name: 'SP OTIFEF', href: '/dashboard/schools/isp-sla', desc: 'On-time · in-full · error-free', group: 'School', section: 'Supply' },
      { name: 'Rate SP & food', href: '/dashboard/schools/ratings', desc: 'Rate suppliers · meal feedback', group: 'School', section: 'Supply' },
      ...
      { name: 'Kitchen', href: '/dashboard/schools/kitchen', desc: 'GRN · issue · waste · substitutions', group: 'School', section: 'Kitchen' },
      { name: 'Kitchen pack', href: '/dashboard/schools/kitchen-pack', desc: 'Mobile · POD · serve offline', group: 'School', section: 'Kitchen' },
      { name: 'Serve day', href: '/dashboard/schools/serve-day', desc: 'Meals today · attendance scale', group: 'School', section: 'Kitchen' },
      { name: 'Kitchen safety', href: '/dashboard/schools/kitchen-safety', desc: 'CoA · R638 · PIC · self-audit', group: 'School', section: 'Kitchen' },
      { name: 'Claims', href: '/dashboard/schools/claims', desc: 'Submit to DBE', group: 'School', section: 'Fund' },
      { name: 'Nutrition', href: '/dashboard/schools/nutrition', desc: 'Meal scores', group: 'School', section: 'Fund' },
      { name: 'Prizes', href: '/dashboard/schools/prizes', desc: 'Prize score', group: 'School', section: 'Fund' },
      { name: 'PEU visits', href: '/dashboard/schools/visits', desc: 'Planned · audit results · RIAD', group: 'School', section: 'Fund' },
      { name: 'Monitoring reports', href: '/dashboard/schools/monitoring', desc: 'DBE field monitoring KPI results', group: 'School', section: 'Fund' },
      { name: 'Workspace', href: '/dashboard/schools/isp', desc: 'SP home', group: 'SP', section: 'Home' },
      { name: 'Fulfil queue', href: '/dashboard/schools/ops', desc: 'POs · DN · dispatch order', group: 'SP', section: 'Home' },
      { name: 'School orders report', href: '/dashboard/schools/sp-orders-report', desc: 'Linked schools · required delivery dates', group: 'SP', section: 'Home' },
      { name: 'Orders inbox', href: '/dashboard/schools/orders', desc: 'Incoming school POs', group: 'SP', section: 'Home' },
      { name: 'Profile', href: '/dashboard/schools/isps', desc: 'Register · profile', group: 'SP', section: 'Home' },
      { name: 'Join DBE', href: '/dashboard/schools/join', desc: 'Associate with DBE', group: 'SP', section: 'Home' },
      { name: 'Catalogue', href: '/dashboard/schools/approved-list', desc: 'Approved foods', group: 'SP', section: 'Supply' },
      { name: 'Menu', href: '/dashboard/schools/menu', desc: 'Department menu', group: 'SP', section: 'Supply' },
      { name: 'MPS / MRP plan', href: '/dashboard/schools/recipes', desc: 'Product needs for schools you supply', group: 'SP', section: 'Supply' },
      { name: 'Feeding calendar', href: '/dashboard/schools/feeding-calendar', desc: 'DBE feeding days for supply planning', group: 'SP', section: 'Supply' },
      { name: 'Deliver', href: '/dashboard/schools/deliveries', desc: 'Dispatch · POD', group: 'SP', section: 'Ops' },
      { name: 'SLA', href: '/dashboard/schools/isp-sla', desc: 'Performance score', group: 'SP', section: 'Ops' },
      { name: 'Invite supplier', href: '/dashboard/invite-business?type=supplier&from=nsnp-sp', desc: 'Business invite · wholesalers', group: 'SP', section: 'Trade' },
      { name: 'Trade / POs', href: '/dashboard/suppliers', desc: 'Buy from wholesalers · book', group: 'SP', section: 'Trade' },
      { name: 'Management report', href: '/dashboard/schools/report', desc: 'A4 landscape PDF · SP workspace metrics', group: 'SP', section: 'Insights' },
