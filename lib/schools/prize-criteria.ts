...
export const SP_PRIZE_CRITERIA: PrizeCriterion[] = [
  {
    ...
    weight: 50,
    how: 'Weighted % by quantity: exact school brand = full; approved same-category OOS sub = half; non-approved commercial lines = zero (allowed on DN, not stocked).',
    tip: 'Ship the school brand when you can. Commercial extras are fine but they dilute your score — put them on a clear “other” line.',
  },
  {
    id: 'fullCompliance',
    label: 'Full-compliance deliveries',
    weight: 25,
    how: 'Bonus only when every DN line is exact school brand (no OOS subs, no commercial extras).',
    tip: 'For max points, keep NSNP lines clean; invoice non-NSNP goods separately when possible.',
  },
  {
    id: 'podPhotos',
