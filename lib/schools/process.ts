...
export const PROCESS_STAGES: Array<{
  ...
  { id: 'kitchen', label: 'Kitchen cover · GRN', short: '5 · Kitchen', color: 'rose' },
...
export const PROCESS_STEPS: ProcessStep[] = [
  ...
  },
  {
    ...
    desc: 'On-time · in-full · error-free · preferred badge',
    school: true,
    agency: true,
  },
  {
  ...
  },
  {
    ...
    desc: 'Feed on calendar days · present → meals → waste',
    school: true,
    agency: false,
    daily: true,
  },
