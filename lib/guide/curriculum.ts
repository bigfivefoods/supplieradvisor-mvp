  ...
  },
  {
    ...
    processes: [
      ...
      },
      {
        ...
        summary: 'Stock → PO → receive → serve → claim.',
        steps: [
          'Check kitchen stock vs menu (Kitchen)',
          'Raise PO to linked SP when short',
          'Confirm POD / GRN on deliveries',
          'Log serve day (desk or field PWA link)',
          'Submit claim only when match + SP SLA are green',
        ],
      },
      {
        name: 'DBE exception cockpit',
        href: '/dashboard/schools/ops',
        summary: 'Daily board for joins, claims, late deliveries, SP probation.',
        steps: [
