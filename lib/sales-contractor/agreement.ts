...
export const SALES_CONTRACTOR_CONTRACT_VERSION = 'ISC-2026.10-ZA';
...
<div class="space-y-5 text-sm leading-relaxed text-slate-700">
  ...
  <p>10.2 <strong>What does not earn commission.</strong> Without limiting clause 10.1, the Contractor is <strong>not</strong> entitled to commission, bonuses, or any economic interest arising from:</p>
  <ul class="list-disc pl-5 space-y-1">
    <li>sales generated by another independent contractor, sales agent, reseller, operator, or employee of the Company or any affiliate;</li>
    <li>sales by a person the Contractor introduced, recruited, mentored, or “connected” who then sells (no downline / second-line commission);</li>
    <li>sales by a customer, supplier, or network connection of a connection, or any multi-hop trading path on SupplierAdvisor or elsewhere;</li>
    <li>recruitment, enrolment, or headcount of other sellers (no pay-for-recruiting);</li>
    <li>passive residual or royalty on others’ turnover after the Contractor’s own deal has closed and been paid, except clawback rules that may reduce the Contractor’s own prior commission.</li>
  </ul>
