...
export default function MemberDentalgraphPortalPage() {
  ...
  return (
    ...
    >
        {youTab ? <B2cAutoLinkBanner token={token} tone="cyan" /> : null}
        ...
        {tab === 'profile' && (
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-4 space-y-3">
            ...
            <p className="text-xs text-slate-500">
              Changes sync to the practice chart and your SA Member wallet.
              Email is used for invites and care messages.
            </p>
            {companyId != null ? (
              <ProfilePhotoField
                companyId={companyId}
