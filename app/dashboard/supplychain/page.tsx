...
export default function SupplyChainPage() {
  ...
  const createPO = () => {
    toast.success(`PO created to ${supplier}`, {
      description: 'Grok has auto-generated BOM and sent to blockchain',
    });
  ...
  return (
    <div className="p-8">
      ...
      <p className="text-neutral-600">
        Order from Kelpack (food) or Packaging World (film)
      </p>
      ...
      <div className="mt-6 flex gap-4">
        ...
        >
          Create PO + Trigger Grok BOM
        </button>
      </div>

      <button className="mt-4 bg-black text-white px-6 py-3 rounded-2xl">
        Ask Grok: “Generate full BOM for this order”
      </button>
    </div>
  );
}