        ...
        <div className="space-y-6">
          ...
          {(store.appointments || []).length === 0 ? (
            <AdvisorEmptyDiary
              ...
              description="Click empty calendar time above, or use New appointment to open the pop-out. Issue clinician portals from Staff so dentists can manage their own diary."
          ...
          <div className="flex flex-wrap items-center justify-between gap-2 -mt-2">
            ...
            <button
              type="button"
              className="rounded-xl border border-sky-300 bg-white px-3 py-2 text-xs font-bold text-sky-800"
