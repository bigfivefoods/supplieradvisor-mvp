...
export default function FieldgraphHarvestPage() {
  ...
  return (
    <FieldgraphWorkbench
      ...
      description="Given your cutting sequence, field estimates and daily allocation for the season, Fieldgraph calculates expected cut start and end dates for each field — multi-crop destinations (mill, silo, buyer)."
    >
      {loading || !store ? (
        <LoadingBlock />
      ) : (
