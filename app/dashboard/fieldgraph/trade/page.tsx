...
export default function FieldgraphTradePage() {
  ...
  return (
    <FieldgraphWorkbench
      ...
      description="This is where CropAdvisor leaves cane-only software behind: harvest destinations connect to mills, silos, and verified buyers on the SupplierAdvisor network — with OTIFEF, settle, and origin lots."
    >
      {loading || !store ? (
        <LoadingBlock />
      ) : (
