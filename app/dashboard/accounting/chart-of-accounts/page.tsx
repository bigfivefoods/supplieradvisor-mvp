  ...
  return (
    <AccountingPage>
      <AccountingHeader
        ...
        description="Posted balances for the period you select. Download that slice as a spreadsheet — opening, period debits and credits, and closing in each account's normal sign."
        action={
          <>
            <button
              type="button"
