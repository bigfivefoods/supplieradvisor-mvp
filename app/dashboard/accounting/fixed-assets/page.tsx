...
export default function FixedAssets() {
  return (
    <div className="pl-0 pr-12 py-12 max-w-screen-2xl mx-auto">
      <Breadcrumb />
      <h1 className="text-6xl font-black tracking-[-3px] text-[#00b4d8] mb-4">Fixed Assets</h1>
      <p className="text-xl text-neutral-600 mb-8">Manage asset register, depreciation schedules, revaluations, and disposals.</p>
