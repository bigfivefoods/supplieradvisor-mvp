...
export default function PractitionersPage() {
  const { companyId, store, loading, saving, post, summary, load } = usePsychiatrygraph();
      ...
      {loading || !store ? (
        ...
        <div className="space-y-6">
                        ...
                        {resolveAdvisorEngagement(profile) === 'contractor' ? (
                          <div className="mt-2">
                            <AdvisorContractorCommercialFields
                              ...
                              inputClass={fc()}
                              labelClass="text-[10px] font-black uppercase tracking-wider text-indigo-800 dark:text-indigo-300"
                              hintClass="text-[11px] text-slate-500 dark:text-indigo-200/70"
          ...
          <AdvisorExpandablePanel
            ...
            accentClass="border-rose-200 bg-rose-50/70 dark:border-rose-700/50 dark:bg-rose-950/40"
            titleClass="text-rose-950 dark:text-rose-50"
            hintClass="text-rose-900/80 dark:text-rose-200/80"
          >
