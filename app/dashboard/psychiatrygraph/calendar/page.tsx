...
export default function CalendarPage() {
  ...
  return (
    <PsychiatrygraphWorkbench
      ...
      description="Practice diary shows all clinicians in parallel. Each practitioner has their own book — no double-booking. Use Clinician diary for a single book."
    >
      {loading || !store ? (
        <LoadingBlock />
      ) : (
