...
export default function CalendarPage() {
          ...
          kind === 'personal'
            ...
            : patients
              ...
              : a.public
                ? 'Open public slot'
                : undefined,
        tone: kind === 'personal' ? ('amber' as const) : ('indigo' as const),
      };
    });
  }, [store]);
  ...
  return (
    <PsychiatrygraphWorkbench
      ...
      description="Main psychiatry diary: click an appointment to open (view/edit · book patient). Click empty time to schedule. Desk waitlist is on this page and under Desk · bookings. Exclusive clinician books — no double-booking."
    >
      {loading || !store ? (
        <LoadingBlock />
      ) : (
        <div className="space-y-6">
          ...
          <WorkingHoursEditor
            ...
            description="Open days and times for this mental health practice. Closed days are dimmed; day view uses your open window."
          ...
          <div className="flex flex-wrap items-center justify-between gap-2 -mt-2">
            ...
            <button
              type="button"
              className="rounded-xl border border-indigo-300 bg-white px-3 py-2 text-xs font-bold text-indigo-800"
            ...
            >
              ...
              {form.date && form.start_time ? (
                <a
                  ...
                  href={`/api/public/advisor/ics?module=psychiatrygraph&date=${encodeURIComponent(form.date)}&start=${encodeURIComponent(form.start_time)}&title=${encodeURIComponent('PsychiatryAdvisor appointment')}&duration=${encodeURIComponent(form.duration_min || '45')}&location=${encodeURIComponent(form.location || '')}`}
                >
              ...
              {selectedId && rosterOnSelected.length > 0 ? (
                <p className="sm:col-span-2 lg:col-span-3 text-[11px] text-slate-600 rounded-xl border border-indigo-100 bg-indigo-50/50 px-3 py-2">
