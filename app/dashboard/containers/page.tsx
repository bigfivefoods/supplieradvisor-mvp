...
function HubInner() {
  ...
  const modules: HubModule[] = [
    ...
    },
    {
      ...
      desc: 'Open an outlet → Inventory to order, receive, and track stock.',
      accent: 'from-rose-50 to-white border-rose-100',
      metric: s?.withContractor ?? '—',
      metricLabel: 'staffed',
    },
    {
    ...
    },
    {
      ...
      metric: s?.contractorsVerified ?? '—',
      metricLabel: 'ID verified',
    },
    {
      ...
      desc: 'Embed live map + metrics (public link / iframe) for partners.',
      accent: 'from-violet-50 to-white border-violet-100',
    },
    {
      ...
      code: '13',
      title: 'Reports',
      desc: 'Impact, feasibility, reseller feedback — live reports for the network.',
      accent: 'from-sky-50 to-white border-sky-100',
    },
  ];
