    ...
    >
      ...
      {loading || !store || !report ? (
        ...
        <div className="space-y-5">
          {/* Filters */}
          <div className="rounded-2xl border border-yellow-200 bg-yellow-50/80 p-4 space-y-3 dark:border-yellow-600/50 dark:bg-yellow-950/40">
            <div className="flex flex-wrap items-center justify-between gap-2">
              <h3 className="text-sm font-black text-yellow-950 dark:text-yellow-50 inline-flex items-center gap-1.5">
                <Filter className="w-4 h-4" /> Slice filters
              </h3>
              <button
                type="button"
                onClick={exportCurrent}
                className="inline-flex items-center gap-1.5 rounded-xl border border-yellow-300 bg-white px-3 py-1.5 text-xs font-bold text-yellow-900 hover:bg-yellow-100 dark:border-yellow-500 dark:bg-yellow-950 dark:text-yellow-100"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-2">
              <label className="block">
                <span className="text-[10px] font-black uppercase text-yellow-800 dark:text-yellow-300">
                  From
                </span>
                <input
                  type="date"
            ...
            <p className="text-[10px] text-yellow-800/70 dark:text-yellow-200/70">
          ...
          {tab === 'overview' && (
            <div className="space-y-4">
              ...
              {report.daily.length > 0 && (
                <div className="rounded-2xl border border-yellow-200 bg-white p-4 dark:border-yellow-600/40 dark:bg-yellow-950/30">
                  <h4 className="text-xs font-black uppercase tracking-wider text-yellow-700 dark:text-yellow-300 mb-3">
                    ...
                    {report.daily.map((d) => (
                      ...
                      >
                        <div className="flex items-end gap-0.5 h-20 w-full justify-center">
                          <div
                            className="w-1.5 rounded-t bg-yellow-200 dark:bg-yellow-700"
                            style={{
                  ...
                  <p className="text-[10px] text-slate-500 mt-2">
                    <span className="inline-block w-2 h-2 rounded-sm bg-yellow-200 mr-1" />{' '}
                    Planned
