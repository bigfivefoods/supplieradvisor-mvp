...
import { FormCard, StatRow, fc } from '@/components/clinic/VetForm';
      ...
      {loading || !store ? (
        ...
        <div className="space-y-6">
          <AdvisorPortalManager
            ...
            portalPath={
              token
                ? `/embed/advisor/vetgraph/${encodeURIComponent(token)}`
                : ''
            }
          ...
          <AdvisorDeskInviteCard module="vetgraph" />
          ...
          {token ? (
            <div className="space-y-2">
              <AdvisorEmbedSnippet
                embedPath={`/embed/advisor/vetgraph/${encodeURIComponent(token)}`}
          ...
          <AdvisorRoomsCard
            ...
            manageHref="/dashboard/vetgraph/rooms"
          ...
          {token ? (
            <div className="rounded-2xl border border-slate-200 dark:border-slate-700 bg-slate-50/80 dark:bg-slate-900/40 p-4 space-y-2">
              ...
              <p className="text-[11px] font-mono break-all text-slate-700 dark:text-slate-200">
                /embed/advisor/vetgraph/{token}
              </p>
              <a
                href={`/embed/advisor/vetgraph/${token}`}
                target="_blank"
                rel="noreferrer"
