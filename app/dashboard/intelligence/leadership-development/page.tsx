            ...
            <div className="relative grid lg:grid-cols-[1.15fr_0.85fr] gap-10 items-center">
              <div>
                ...
                <p className="text-xs text-neutral-400 mt-4">
                  ~10–15 minutes · honest scores beat perfect ones · progress saves to your company
                </p>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-4">
            ...
            <Panel title="How it works on SupplierAdvisor">
              <div className="px-5 py-5 space-y-3 text-sm text-neutral-600 leading-relaxed">
                ...
                <p>
                  Progress saves to your company profile so leadership development sits beside
                  network, trade, and intelligence — not in a separate silo.
                </p>
        ...
        <div className="space-y-8">
          ...
          <div className="rounded-[2rem] border border-neutral-200 bg-white p-6 sm:p-8">
            ...
            <p className="text-sm text-neutral-500 leading-relaxed max-w-3xl mb-4">
              Super-Cube® sits inside your intelligence workspace so development is never detached
              from real trade, trust, and relationships. Stronger leaders build fairer supplier
              networks, clearer customer partnerships, and decisions that serve people — not only
