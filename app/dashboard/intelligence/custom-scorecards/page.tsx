...
export default function CustomScorecards() {
  return (
    <div className="pl-0 pr-12 py-12 max-w-screen-2xl mx-auto">
      <Breadcrumb />
      <h1 className="text-6xl font-black tracking-[-3px] text-[#00b4d8] mb-4">Custom Scorecards</h1>
      <p className="text-xl text-neutral-600 mb-8">Build, track, and share custom KPIs, impact metrics, and performance scorecards tailored to your goals.</p>
