...
export default function InboundLogistics() {
  return (
    <div className="pl-0 pr-12 py-12 max-w-screen-2xl mx-auto">
      <Breadcrumb />
      <h1 className="text-6xl font-black tracking-[-3px] text-[#00b4d8] mb-4">Inbound Logistics</h1>
      <p className="text-xl text-neutral-600 mb-8">Track inbound shipments, supplier deliveries, and warehouse receipts.</p>
