    ...
    <div className="space-y-6">
      ...
      <div className="grid sm:grid-cols-2 gap-3">
        <div className="rounded-3xl border border-sky-200 bg-gradient-to-br from-sky-50 to-white p-5 shadow-sm">
          <div className="text-xs uppercase text-sky-800 font-bold">Weighted revenue</div>
          <div className="text-2xl font-black text-slate-900 mt-1">{formatZar(totalAmt)}</div>
        </div>
        <div className="rounded-3xl border border-amber-200 bg-gradient-to-br from-amber-50 to-white p-5 shadow-sm">
          <div className="text-xs uppercase text-amber-800 font-bold">
      ...
      <div className="rounded-3xl border border-neutral-200 bg-white p-5 sm:p-6 shadow-sm">
        <p className="text-xs text-neutral-600 mb-3">
          ...
          {' · '}
          <span className="text-orange-700 font-semibold">Commission</span>
          {' · by expected close week'}
        </p>
        <div className="h-80 rounded-2xl bg-slate-50 border border-neutral-100 p-2 sm:p-3">
          <ForecastBarChart
