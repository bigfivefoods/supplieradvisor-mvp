...
const MODULES = [
  ...
  },
  {
    ...
    title: 'VetAdvisor®',
    short: 'VetAdvisor',
    tagline: 'Veterinary practice OS',
    body: 'Vets and veterinary nurses, POPIA-aware clients, wellness packs & treatment plans, multi-room exclusive diaries, waitlist desk, clinical chart with vaccines linked to consults, client portal, in-app messaging, marketplace listing, and practice website.',
    bullets: [
      'Multi-room diaries · no double-book',
      'Waitlist · vaccines · consult notes',
      'Client app · marketplace · care messages',
    ],
    Mock: VetgraphMock,
    icon: PawPrint,
  },
  ...
  },
  {
    ...
    body: 'Retailers ring up SKUs and take cash, or present a QR / NFC so the customer pays on SA Member. The same till can open their gym, clinic and hire bills — they tap or scan and pay the merchant they owe. GymAdvisor and clinic desks use the same present-to-pay path.',
    bullets: [
      'Till basket · cash or phone pay',
      'QR + NFC (Android Chrome) · iPhone scans QR',
      'Collect SA Member bills at the counter',
    ],
    Mock: RetailgraphMock,
    icon: Store,
  },
  {
    id: 'schools',
