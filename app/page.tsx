  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-lg border-b border-slate-100">
        <div className="max-w-screen-2xl mx-auto px-4 sm:px-8 md:px-12 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-6 md:gap-10 text-base md:text-lg font-medium">
            ...
            <button
              onClick={login}
              className="px-6 md:px-8 py-3.5 bg-[#00b4d8] hover:bg-[#0099b8] text-white rounded-3xl font-semibold transition-all flex items-center gap-2"
            >
      ...
      {/* How it Works */}
      <div id="how-it-works" className="bg-white py-16 md:py-24 px-6 md:px-12">
      ...
      {/* For Business */}
      <div id="for-business" className="py-16 md:py-24 px-6 md:px-12 bg-[#f8fafc]">
        <div className="max-w-screen-2xl mx-auto">
          <div className="grid md:grid-cols-12 gap-12 items-center">
            ...
            <div className="md:col-span-7">
              <div className="card p-8 md:p-12 text-lg md:text-xl space-y-10">
      ...
      {/* For Consumers */}
      <div id="for-consumers" className="py-16 md:py-24 px-6 md:px-12 bg-white">
        <div className="max-w-screen-2xl mx-auto">
          <div className="grid md:grid-cols-12 gap-12 items-center">
            <div className="md:col-span-7">
              <div className="card p-8 md:p-12 text-lg md:text-xl space-y-10">
      ...
      {/* Final CTA */}
      <div className="bg-slate-900 text-white py-16 md:py-24 px-6 md:px-12 text-center">
