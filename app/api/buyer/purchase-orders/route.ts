...
export async function GET(request: NextRequest) {
  try {
    ...
    const poListCols =
      'id, po_number, status, total_amount, currency, buyer_profile_id, supplier_profile_id, supplier_id, seller_customer_id, created_at, updated_at, promised_date, actual_delivery_date, items, description, onchain_po_id, invoice_id, supplier_wallet, metadata';
