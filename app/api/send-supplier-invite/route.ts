        ...
        <div style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; max-width: 620px; margin: 0 auto; background: #ffffff; border-radius: 16px; overflow: hidden; border: 1px solid #e5e7eb;">
          ...
          <div style="padding: 40px 40px 20px;">
            ...
            <p style="color: #374151; font-size: 16px; line-height: 1.7; margin: 0 0 32px;">
              Click the button below to review your company details and create your account. This will only take a few minutes.
            </p>

            <!-- CTA Button -->
            <div style="text-align: center; margin: 32px 0 40px;">
              <a href="${inviteLink}" 
                 style="background-color: #00b4d8; color: white; padding: 18px 48px; border-radius: 9999px; text-decoration: none; font-weight: 600; font-size: 17px; display: inline-block; box-shadow: 0 4px 6px -1px rgb(0 0 0 / 0.1);">
