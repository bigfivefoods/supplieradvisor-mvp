...
// Mock data (replace with real Supabase fetch when login is fixed)
const mockProfile = {
  user_id: 'did:privy:cmmkpm8vy02710cjx930ju861',
  address: '111 Main Road, Durban, KZN',
  bank_account: 'FNB Acc: 2222222222, Branch: 250655',
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-12 gap-6">
          <div>
            ...
            <p className="text-xl text-gray-400 mt-3">
              Wallet: {mockProfile.user_id.slice(0, 10)}...{mockProfile.user_id.slice(-6)}
            </p>
          </div>
