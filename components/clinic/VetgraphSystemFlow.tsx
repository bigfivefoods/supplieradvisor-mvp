...
/**
 * End-to-end VetAdvisor® process design:
 ...
 *
 * Expandable on the VetAdvisor command hub; downloadable A4 PDF
 * (landscape + portrait) — same pattern as GymAdvisor / CropAdvisor.
 * Content kept in sync with lib/clinic/vetgraph-process-guide.ts
 */
...
import VetgraphProcessPdfButtons from '@/components/clinic/VetgraphProcessPdfButtons';
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        who: 'Owner / system',
        desc: '24h VetAdvisor® email with practice logo: update SA Member profile + list ailments. After the visit: rate the session and the practice.',
        href: '/dashboard/vetgraph/bookings',
        icon: Mail,
      },
      {
    ...
    steps: [
      {
        ...
        href: '/dashboard/vetgraph/accounts',
        icon: CreditCard,
      },
      {
        id: 'publish',
...
export default function VetgraphSystemFlow({
  compact,
  ...
  return (
    <section
      ...
      aria-label="VetAdvisor full process design"
      id="vetgraph-system-flow"
    >
      <div className="bg-gradient-to-r from-emerald-950 via-emerald-800 to-cyan-700 px-5 py-4 text-white">
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-2 shrink-0">
            <VetgraphProcessPdfButtons variant="map" />
            <button
              type="button"
              onClick={() => setOpen((v) => !v)}
      ...
      {open ? (
        <div className="p-4 sm:p-6 space-y-8">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 pt-1 border-t border-slate-100">
            ...
            <VetgraphProcessPdfButtons variant="inline" />
          </div>
        </div>
      ) : null}
    </section>
