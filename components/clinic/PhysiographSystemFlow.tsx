...
const PHASES: Phase[] = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        who: 'Practitioner',
        desc: 'Injury notes, medical aid, docs, claims, scripts; visit notes & scores. Optional identity verify on portal.',
        href: '/dashboard/physiograph/patients',
        icon: FileText,
      },
      {
        ...
        <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3">
          ...
          >
            ...
            <p className="text-sm text-white/90 mt-1.5 max-w-3xl leading-snug">
              Workforce in People (employed + contractors; leave blocks the diary).
              Patients on Customers 360 with VAT invoices. Company calendar, CRM
              activity and Intelligence — one OS.
            </p>
          </button>
