...
const PHASES = [
  ...
  },
  {
    ...
    steps: [
      ...
      {
        n: '2b',
        title: 'Request hire (portal / desk)',
        who: 'Customer',
        desc: 'Customer portal or desk books against catalogue; dual fee quote + requirements.',
      ...
      },
      {
        ...
        who: 'Customer',
        desc: 'Self-serve KYC on portal (licence, castle safety…) or desk checklist.',
        href: '/dashboard/hiregraph/customers',
        icon: CheckCircle2,
      },
    ],
