...
const PHASES = [
  {
    ...
    steps: [
      {
        n: '1a',
        title: 'Core Suppliers (SRM)',
        who: 'Supplier',
        desc: 'Add gear owners in Core Suppliers module — HireAdvisor links to those rows.',
      ...
      },
      {
        ...
        who: 'Platform',
        desc: 'Plant, vehicles, tools, kids party… each has different requirements.',
  ...
  },
  {
    ...
    steps: [
      {
        n: '2a',
        title: 'Core Customers (CRM)',
        who: 'Customer',
        desc: 'Renters live in Core Customers; set hire-only KYC checklist here.',
      ...
      },
      {
        ...
        who: 'Customer',
        desc: 'Book a core customer against catalogue; dual fee quote + requirements.',
      ...
      },
      {
        ...
        who: 'Customer',
        desc: 'Licence, deposit, castle safety — tracked in hire KYC per CRM customer.',
